...
public class NoEntryLoginDialog extends DialogFragment implements UserView {

    UserPresenter userPresenter;
    TextView tvAceptar,tvtexto;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        View view = getActivity().getLayoutInflater().inflate(R.layout.appu_no_entry_login_dialog, new LinearLayout(getActivity()), false);

        tvAceptar = (TextView) view.findViewById(R.id.tvAceptar);
        tvtexto = (TextView) view.findViewById(R.id.tvtexto);
        loading= new TransparentProgressDialog(getContext());

        String bundle = getArguments().getString("mensaje");

        mensajeeee=bundle;

        tvtexto.setText(mensajeeee);
