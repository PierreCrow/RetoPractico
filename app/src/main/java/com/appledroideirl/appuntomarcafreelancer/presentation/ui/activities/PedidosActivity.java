...
public class PedidosActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.appu_pedidos_activity);
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (action.equals("REFUSE")) {
                            ...
                            userPresenter.refuseRequest(Helper.getUserAppPreference(getApplicationContext()).getToken(), idRequest);
                        } else {
                            if (action.equals("ACEPT")) {
                                if (!loading.isShowing()) {
                                    loading.show();
                                }
                                userPresenter.aceptRequest(Helper.getUserAppPreference(getApplicationContext()).getToken(), idRequest);
                            }
                        }
                    }
                })
