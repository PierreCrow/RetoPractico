...
public class TabDisponibilidadEnLocalFragment extends BaseFragment
        implements UserView {
        ...
        new AlertDialog.Builder(getContext(), R.style.AlertDialogCustom)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        wsParameterAgregarDateAvailable.setId_type_availability(2);
                        wsParameterAgregarDateAvailable.setFull_name("En Local");
    ...
    public void listAvailableDateHourSuccess(WsResponseAvailableDateHour wsResponseAvailableDateHour) {
        ...
        for (WsDataAvailableDateHour wsDataAvailableDateHour : wsResponseAvailableDateHour.getWsDataAvailableDateHours()) {
            ...
            if (wsDataAvailableDateHour.getId_type_availability() == 2) {
    ...
    public void dateAvailableAddedSuccess(String message) {
        ...
        Toast.makeText(getContext(), "Se actualizó su disponibilidad", Toast.LENGTH_LONG).show();
